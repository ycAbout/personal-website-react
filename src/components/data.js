const summaryList = [
    'Ten years cognitive psychology research experience: design experiments and analyze data to study human learning, memory and cognition.',
    'Software developer | Permanent Resident of Canada'
]

const skillsList = [
    'Research: Quantitative human research, experiment design, data analysis (Taught statistics)',
    'Programing: Python, Reactjs, Nodejs, Html, CSS, JavaScript, SQL, Mongodb, Blockchain (Hyperledeger Fabric), SPSS',
...
const experiences = {
    job1: {title: "Software and Blockchain Developer | 2017 – Present",
        company: "Department of Computer Science, University of Saskatchewan", 
        note: "Main duty: 1. Develop a blockchain solution (Reactjs + Nodejs + Mongodb / Blockchain) for psychology test data management (Master Thesis). 2. Developed a job seeking applicaiton for STC"
    },
    job2: {title: "Research Analyst | 2017 – Present",
        company: "Department of Psychology, University of Saskatchewan",
        note: "Main duty: 1. Design experiments and analyze data to study human cognition. 2. Taught course: PSY355 Research in Advanced Cognitive Science (2017-2018)"
    },
    job3: {title:"Post-doctoral Fellow | 2013-2017",
        company: "Department of Psychology, University of Saskatchewan",
        note: "NSERC Fellow | 2015-2017. Main duty: design experiments and analyze data to study human learning, memory and cognition."
    }
}
...
export {eduList, awardList, grantList, paperList, bookList, conferenceList, experiences, summaryList, achievementsList, skillsList};
